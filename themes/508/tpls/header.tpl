...
if (SUGAR.ajaxUI && !SUGAR.ajaxUI.hist_loaded)
{
	...
	{if $smarty.request.module != "ModuleBuilder"}{* Module builder will init YUI history on its own *}
...
.html("{$APP.LBL_KEYBOARD_SHORTCUTS_HELP}")
.dialog({
	autoOpen: false,
	title: '{$APP.LBL_KEYBOARD_SHORTCUTS_HELP_TITLE}',
	width: 300,
	position: {
	    my: 'right top',
	    at: 'left top',
