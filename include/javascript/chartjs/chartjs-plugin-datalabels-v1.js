...
/* Modified by Sugar
  Notes: We need this for the funnel chart that is using ChartJS v2. V1 of the datalabels package is compatible with
  ChartJs v2, but V2 of the datalabels package incompatible.
  
  Some changes needed to be made to this file because we have two versions of each package:
  e.g. "global.ChartDataLabelsV1 = factory(window.Chart2)" was global.ChartDataLabels = factory(window.Chart2)
  Chart was changed to Chart2 in several places.

  Also, the orient method was throwing an error because origin was null for the funnel chart.
*/

(function (global, factory) {
typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('Chart_2_9_4.js')) :
typeof define === 'function' && define.amd ? define(['Chart_2_9_4.js'], factory) :
(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ChartDataLabelsV1 = factory(window.Chart2));
}(this, (function (Chart2) { 'use strict';
...
function orient(point, origin) {
  ...
  // Modified code by Sugar
  // vScale is optional, which will cause the origin to be null and cause this to break at var x0 = origin.x
  // See unfixed issue: https://github.com/chartjs/chartjs-plugin-datalabels/issues/141
  if (!origin) {
    origin = {
      x: 0,
      y: 0
