 ...
 * PLACE ANY CUSTOMIZATIONS IN abcde_MyCustomModule
 */

require_once 'include/SugarObjects/templates/issue/Issue.php';

class abcde_MyCustomModule_sugar extends Issue {
    public $new_schema = true;
    public $module_dir = 'abcde_MyCustomModule';
    public $object_name = 'abcde_MyCustomModule';
    public $table_name = 'abcde_mycustommodule';
    ...
    public $sync_key;
    public $abcde_mycustommodule_number;
    public $type;
    public $status;
    public $priority;
    public $resolution;
