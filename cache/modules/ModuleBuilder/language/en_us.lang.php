...
',
  ...
  'LBL_POPHELP_REQUIRED' => 'Create a formula to determine whether this field is required in layouts.<br/>Required fields will follow the formula in the browser-based mobile view, <br/>but will not follow the formula in the native applications, such as Sugar Mobile for iPhone. <br/>They will not follow the formula in the Sugar Self-Service Portal.',
  'LBL_POPHELP_READONLY' => 'Create a formula to determine whether this field is read only in layouts.<br/>Read only fields will follow the formula in the browser-based mobile view, <br/>but will not follow the formula in the native applications, such as Sugar Mobile for iPhone. <br/>They will not follow the formula in the Sugar Self-Service Portal.',
