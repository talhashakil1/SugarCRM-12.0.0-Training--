...
%s',
  ...
  'LBL_SCAN_451_LOG' => 'AuthN code was deleted, use \\IdMSugarAuthenticate, \\IdMSAMLAuthenticate, \\IdMLDAPAuthenticate instead. Files which use deleted code: 
%s',
  ...
  'LBL_SCAN_435_LOG' => 'Class SugarSession was removed from API, use Sugarcrm\\Sugarcrm\\Session\\SessionStorage instead. Files with deprecated code: 
%s',
...
%s',
  ...
  'LBL_SCAN_451_TITLE' => 'AuthN code was deleted, use \\IdMSugarAuthenticate, \\IdMSAMLAuthenticate, \\IdMLDAPAuthenticate instead. Files which use deleted code: 
%s',
  ...
  'LBL_SCAN_546_DESCR' => 'Cannot migrate custom TinyMCE config in Knowledge Base module. The "tinyConfig" parameter in %s file will be emptied. If you have any TinyMCE customizations there you should save them before upgrade and add after upgrade manually.',
