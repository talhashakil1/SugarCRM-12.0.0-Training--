...
/* Smarty version 3.1.39, created on 2022-07-22 19:20:30
  from '/var/www/html/SugarEnt-Full-12.0.0/ModuleInstall/PackageManager/tpls/PackageManagerScripts.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_62dab22e61c5e7_00909551',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a80509c2688fcbbbfd821df841d50f0828638a56' => 
    array (
      0 => '/var/www/html/SugarEnt-Full-12.0.0/ModuleInstall/PackageManager/tpls/PackageManagerScripts.tpl',
      1 => 1649221076,
      2 => 'file',
    ),
  ),
...
function content_62dab22e61c5e7_00909551 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/var/www/html/SugarEnt-Full-12.0.0/include/SugarSmarty/plugins/function.sugar_getscript.php','function'=>'smarty_function_sugar_getscript',),1=>array('file'=>'/var/www/html/SugarEnt-Full-12.0.0/include/SugarSmarty/plugins/function.sugar_csrf_form_token.php','function'=>'smarty_function_sugar_csrf_form_token',),));
	        				...
	        				if(typeof result != 'undefined') {
								...
								for (var x = 0; x < result['updates'].length; x++){
									...
									if(result['updates'][x]['type'] == 'patch'){
										tmpNodeRelease.onCheckClick = function(){
                                            this.uncheck();
                                            if(confirm('<?php echo $_smarty_tpl->tpl_vars['MOD']->value['MI_REDIRECT_TO_UPGRADE_WIZARD'];?>
')){
...
<?php if ($_smarty_tpl->tpl_vars['module_load']->value == 'true') {?>
		...
		_fileGrid = new YAHOO.widget.ScrollingDataTable(
            ...
            [
                {
                    key: 'name',
                    label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Name'];?>
',
                ...
                {
                    key: 'file',
                    label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Install'];?>
',
                    minWidth: Math.round(patch_downloads_minWidth / 1.5),
                ...
                {
                    key: 'unFile',
                    label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Delete'];?>
',
                ...
                {
                    key: 'type',
                    label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Type'];?>
',
                    minWidth: Math.round(patch_downloads_minWidth / 1.5)
                },
                {
...
',
                ...
                {
                    key: 'date',
                    label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Published'];?>
',
                    minWidth: Math.round(patch_downloads_minWidth)
                },
                {
                    key: 'uninstallable',
                    label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRID_COLUMN']->value['Uninstallable'];?>
',
                    minWidth: Math.round(patch_downloads_minWidth / 1.5)
                },
                {
...
',
    ...
    _fileGridInstalled = new YAHOO.widget.ScrollingDataTable('installed_grid',
        [
            {
                key: 'name',
                label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']->value['Name'];?>
',
                sortable: true,
            ...
            {
                key: 'unFile',
                label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']->value['Action'];?>
',
            ...
            {
                key: 'state_file',
                label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']->value['Enable_Or_Disable'];?>
',
            ...
            {
                key: 'type',
                label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']->value['Type'];?>
',
                'minWidth': Math.round(minWidth / 1.5)
            },
            {
                key: 'version',
                label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']->value['Version'];?>
',
                'minWidth': Math.round(minWidth)
            },
            {
                key: 'date',
                label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']->value['Date_Installed'];?>
',
                'minWidth': Math.round(minWidth)
            },
            {
                key: 'description',
                label: '<?php echo $_smarty_tpl->tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']->value['Description'];?>
',
                sortable: true,
                'minWidth': Math.round(minWidth * 1.5)
            }
...
" />';
        ...
        output += '<?php echo smarty_function_sugar_csrf_form_token(array(),$_smarty_tpl);?>
';
